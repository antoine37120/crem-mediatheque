<div>
    <div class="card-track bg-transparent position-relative row m-0">
        ...
        <div class="col-3 col-md-12 justify-content-between flex-shrink-1 flex-nowrap mx-0 ps-0 ps-md-3 pe-0 pb-4 pb-md-0">
            <div class="position-relative p-0 col-11 col-md-9 max-w-img-card-list" style="">
                <img src="{{ url('storage/'.$track->picture) }}"
                     ...
                     style="background: {{ $track->getHexaColor() }};" width="150" height="150"
                ...
                <div class="card-track-actions position-absolute top-0 end-0 p-1 d-none d-md-block">
                    {{-- top-0 end-0 --}}
        ...
        <div class="col-3 d-block d-md-none text-right ps-0 pe-0">
            <livewire:tracks.actions :track="$track"  wire:key="actions-mobile-{{ $track->id }}"/>
        </div>
        {{-- <div class="card-track-actions mobile-tracks flex-shrink-1 d-block d-md-none m-0 p-1">
        </div>--}}
    </div>
