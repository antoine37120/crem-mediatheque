<div>
    <div class="d-flex column-gap-2 justify-content-end p-1 action-buttons">
        <div x-data="trackinfos_play_{{ $track->id }}">
            <button x-on:click="addtoplay" type="button" aria-label="play" class="btn btn-lg btn-light rounded-circle p-0 d-flex align-items-center justify-content-center bg-red border border-dark border-2 text-white">
        ...
        <div x-data="trackinfos_{{ $track->id }}">
            <button x-on:click="addtolist" type="button" aria-label="add to playlist" class="btn btn-lg btn-light rounded-circle p-0 d-flex align-items-center justify-content-center bg-red border border-dark border-2 text-white">
