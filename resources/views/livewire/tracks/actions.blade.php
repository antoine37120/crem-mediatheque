<div>
    <div class="d-flex column-gap-2 justify-content-end p-1">
        <div x-data="trackinfos_play_{{ $track->id }}">
            <button x-on:click="addtoplay" type="button" class="btn btn-light rounded-circle p-0 d-flex align-items-center justify-content-center">
