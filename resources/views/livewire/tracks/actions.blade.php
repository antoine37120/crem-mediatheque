<div>
    <div class="d-flex column-gap-2 justify-content-end p-1 pt-0 pt-md-1 action-buttons">
        <div x-data="trackinfos_play_{{ $track->id }}">
            <button x-on:click.stop="addtoplay" type="button" aria-label="play" class="btn btn-light rounded-circle position-relative p-0 d-flex align-items-center justify-content-center">
        ...
        <div x-data="trackinfos_{{ $track->id }}">
            <button x-on:click.prevent="addtolist" type="button" aria-label="add to playlist" class="btn btn-light rounded-circle p-0 d-flex align-items-center justify-content-center">
