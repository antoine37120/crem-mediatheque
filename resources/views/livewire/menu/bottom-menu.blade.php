{{-- mobile --}}
<div>
    <div class="row fixed-bottom p-2 flex-nowrap">
        ...
        <div class="col-4 text-center d-flex flex-column">
            <a href="{{route('search')}}" class="text-black text-decoration-none" wire:navigate>
                <div>Search</div>
        ...
        <div class="col-4 text-center d-flex flex-column">
            <a href="{{route('cmsPage', ['cmsPage' => 'abaout']) }}" class="text-black text-decoration-none" wire:navigate>
                <div>About</div>
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-question" viewBox="0 0 16 16">
