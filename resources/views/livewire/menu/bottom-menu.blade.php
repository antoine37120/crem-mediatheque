                             ...
                             {{-- bottom-100  --}}
                                <div class="m-auto">
                                    <ul class="list-unstyled text-nowrap fs-5 d-grid gap-0 mb-4 text-center">
                                        <li>
                                            <div class="text-end text-decoration-none d-block pb-1 border-bottom border-black-40 mb-3 pe-5"
                                                x-ref="close-menu"
                                                x-on:click="close()">
                                                <a href="" style="color: rgba(var(--bs-black-rgb), var(--bs-text-opacity))">
