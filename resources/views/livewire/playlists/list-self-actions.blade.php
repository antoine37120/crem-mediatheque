<div>
    <div class="d-flex column-gap-2 justify-content-end">
        <div x-data="trackinfos_playlist_clear_{{ $playlist->id }}">
            <button x-on:click.stop="addtolistClear" type="button" class="btn btn-light rounded-circle position-relative p-0 d-flex align-items-center justify-content-centere">
        ...
        <div x-data="trackinfos_playlist_{{ $playlist->id }}">
            <button x-on:click.stop="addtolist" type="button" class="btn btn-light rounded-circle position-relative p-0 d-flex align-items-center justify-content-centere">
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-play-fill p-1" viewBox="0 0 16 16">
