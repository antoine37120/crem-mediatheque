<div>
    <div class="d-flex column-gap-2 justify-content-end">
        <div x-data="trackinfos_playlist_{{ $playlist->id }}">
            <button x-on:click="addtolist" type="button" class="btn btn-lg btn-light rounded-circle p-0 d-flex align-items-center justify-content-center">
        ...
        <div x-data="trackinfos_playlist_random_{{ $playlist->id }}">
            <button x-on:click="addtolist" type="button" class="btn btn-lg btn-light rounded-circle p-1 d-flex align-items-center justify-content-center">
